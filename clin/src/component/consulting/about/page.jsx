...
>
  ...
  <div className="mb-8 flex justify-start">
    ...
    >
      <h3
        className="text-white italic font-medium text-2xl"
      ...
      />
        ...
        <div className="flex items-center">
          <div className="max-w-2xl">
            ...
            >
              At ClinXcel, we
              provide comprehensive global Pharmacovigilance Consulting services
            ...
            >
              ...
              ClinXcel
              empowers clients to address Product Safety concerns confidently
              and proactively. Whether it involves establishing robust systems,
              supporting audit readiness, leveraging technology and AI, or
              deploying specialized staff, we deliver unparalleled, tailored
