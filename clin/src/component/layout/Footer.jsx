...
const Footer = () => {
  return (
    <footer
      className={`bg-gradient-to-r from-green-400 to-cyan-500 text-black pt-16 pb-0 mt-10 relative overflow-hidden ${poltawski.className}`}
    >
      {/* ===== MAIN GRID ===== */}
      ...
      <div className="bg-black text-white text-center py-4 text-sm font-semibold relative z-10">
        ...
        | Designed by <span className="font-bold">Find Solution</span>
      </div>
    </footer>
  );
};
