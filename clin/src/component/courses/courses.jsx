  ...
  return (
    <section className="w-full bg-white flex flex-col items-center py-12 px-4 md:px-12">
      ...
      <div className="relative w-full max-w-6xl text-center">
        ...
        <div className="bg-[#0b4054] text-white px-8 py-6 rounded-b-2xl shadow-md">
      ...
      <div className="w-full max-w-7xl mt-16">
        <div className="flex justify-center mb-10">
          <div className="bg-[#d4f4ec] px-10 py-3 rounded-xl shadow-sm">
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 place-items-center">
          {courses.map((course, index) => (
            <div
              key={index}
              className="relative bg-[#f9f9f9] border border-gray-200 shadow-md rounded-xl p-6 w-[95%] sm:w-[90%] md:w-[85%] transition-transform transform hover:-translate-y-2 hover:shadow-lg"
            >
